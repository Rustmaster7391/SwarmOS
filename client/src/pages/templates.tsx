      ...
      <div className="flex flex-col">
        ...
        <div className="bg-dark-200 border-b border-gray-700 px-3 sm:px-6 py-3 sm:py-6">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">Deploy Swarm</h1>
            <p className="text-gray-400 text-xs sm:text-sm lg:text-base mt-1 sm:mt-2">Next-gen swarm blueprints with emergent intelligence patterns</p>
          </div>
        </div>
